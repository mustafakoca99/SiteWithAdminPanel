<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ekle.aspx.cs" Inherits="aspnet_websitem.ekle" %>
...
function closeNav() {
  document.getElementById("YanMenu").style.width = "0";
            ...
            <asp:Label ID="Label1" runat="server" Text="id:"></asp:Label>
                ...
                <br />
                <br />
                <asp:Button ID="Button1" runat="server" Text="Ekle" Width="191px" OnClick="Button1_Click" />
                <br />
                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Tabloyu Yenile" Width="197px" />
                </div>
