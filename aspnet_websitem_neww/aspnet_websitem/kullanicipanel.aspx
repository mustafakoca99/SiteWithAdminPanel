<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kullanicipanel.aspx.cs" Inherits="aspnet_websitem.kullanicipanel" %>
...
<a href="index.aspx" style="text-decoration:none;">Panel Çıkış (TIKLA)</a>
  ...
  <a href="kullanicipanel.aspx">Panel AnaSayfa</a>
  <a href="#">Yorumlar(Boş)</a>
  <a href="#">Eklentiler(Boş)</a>
                <a href="#">Kullanıcı bilgileri(Boş)</a>
</div>
...
function closeNav() {
  document.getElementById("YanMenu").style.width = "0";
            ...
            <h1 style="text-align:center; color:brown;">KULLANICI PANELİNE HOŞ GELDİN!</h1>
        <div style="text-align:center; color:brown;"><b>KULLANICI SAHİBİ BİLGİLERİ!</b></div>
           <br /> <table>
  <tbody>
    <tr>
